...
def send_nordpool(broker_address, topic, user, password, homeassistant_api_url, homeassistant_api_token):
    ...
    current_price = nordpool_prices.get("state")
    ...
    color_dict = [(key, value) for key, value in color_matrix_json.items()]
    message_duration = 30
    icon = 54077
    ...
    context = {
        ...
        "color_matrix_json": color_matrix_json,
